...
int Graphics::copy_texture(SDL_Texture* texture, const SDL_FRect* src, const SDL_FRect* dest)
{
    bool is_substituted = substitute(&texture);

    const int result = SDL_RenderTexture(gameScreen.m_renderer, texture, src, dest);
    if (result == 0)
    {
...
int Graphics::copy_texture(SDL_Texture* texture, const SDL_FRect* src, const SDL_FRect* dest, const double angle, const SDL_FPoint* center, const SDL_FlipMode flip)
{
    bool is_substituted = substitute(&texture);

    const int result = SDL_RenderTextureRotated(gameScreen.m_renderer, texture, src, dest, angle, center, flip);
    if (result == 0)
    {
        WHINE_ONCE_ARGS(("Could not copy texture: %s", SDL_GetError()));
    }
...
int Graphics::fill_rect(const SDL_FRect* rect)
{
...
int Graphics::fill_rect(const SDL_FRect* rect, const int r, const int g, const int b, const int a)
{
    set_color(r, g, b, a);
    return fill_rect(rect);
}

int Graphics::fill_rect(const SDL_FRect* rect, const int r, const int g, const int b)
{
...
int Graphics::fill_rect(const SDL_FRect* rect, const SDL_Color color)
{
...
int Graphics::draw_rect(const SDL_FRect* rect)
{
    const int result = SDL_RenderRect(gameScreen.m_renderer, rect);
    if (result == 0)
    {
...
int Graphics::draw_rect(const SDL_FRect* rect, const int r, const int g, const int b, const int a)
{
    set_color(r, g, b, a);
    return draw_rect(rect);
}

int Graphics::draw_rect(const SDL_FRect* rect, const int r, const int g, const int b)
{
    return draw_rect(rect, r, g, b, 255);
}

int Graphics::draw_rect(const SDL_FRect* rect, const SDL_Color color)
{
...
{
    const int result = SDL_RenderLine(gameScreen.m_renderer, x, y, x2, y2);
    if (result == 0)
    {
...
int Graphics::draw_points(const SDL_FPoint* points, const int count)
{
    const int result = SDL_RenderPoints(gameScreen.m_renderer, points, count);
    if (result == 0)
    {
...
int Graphics::draw_points(const SDL_FPoint* points, const int count, const int r, const int g, const int b)
{
    set_color(r, g, b);
